        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="col-span-1">
              <Label htmlFor="edit-lot" className="block mb-2">
                LOT
              </Label>
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-product" className="block mb-2">
                ผลิตภัณฑ์
              </Label>
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-ordered-quantity" className="block mb-2">
                จำนวนที่สั่ง
              </Label>
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-production-quantity" className="block mb-2">
                จำนวนที่ผลิต
              </Label>
              <div className="flex items-center">
                <Input
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-qc-quantity" className="block mb-2">
                จำนวน QC
              </Label>
              <Input id="edit-qc-quantity" type="text" value={order.qcQuantity} disabled className="bg-gray-100" />
            </div>

            <div className="col-span-2">
              <Label htmlFor="edit-electricity-cost" className="block mb-2">
                ค่าไฟการผลิต
              </Label>
              <Input
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-material-cost" className="block mb-2">
                ต้นทุนวัตถุดิบ
              </Label>
              <Input
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-total-cost" className="block mb-2">
                ต้นทุนรวม
              </Label>
              <Input
                id="edit-total-cost"
            ...
            <div className="col-span-2">
              <Label htmlFor="edit-selling-price" className="block mb-2">
                ราคาขาย
              </Label>
              <Input
          ...
          <div className="flex justify-between pt-4">
            <Button onClick={onClose} className="bg-gray-300 hover:bg-gray-400 text-black px-6" disabled={isUpdating}>
              ย้อนกลับ
            </Button>
            <Button
              onClick={handleSave}
